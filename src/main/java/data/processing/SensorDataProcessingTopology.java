...
public class SensorDataProcessingTopology extends BaseTruckEventTopology 
{
    private static final String KAFKA_SPOUT_ID = "kafkaSpout"; 
    private static final String HDFS_BOLT_ID = "hive_Bolt";
    private static final String MONITOR_BOLT_ID = "monitorBolt";
    private static final String HBASE_BOLT_ID = "hbase_Bolt"; 
    private static final String LOG_TRUCK_BOLT_ID = "logTruckEventBolt";
            
    public SensorDataProcessingTopology(String configFileLocation) throws Exception 
    {
	...
	conf.setDebug(true);
        ...
        StormSubmitter.submitTopology("Iot-data-Processing", 
                                    conf, builder.createTopology());
    }

    public static void main(String[] str) throws Exception
    {
        String configFileLocation = "iot_data_topology.properties";
        SensorDataProcessingTopology truckTopology 
                = new SensorDataProcessingTopology(configFileLocation);
