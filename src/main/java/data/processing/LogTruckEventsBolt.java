...
public class LogTruckEventsBolt extends BaseRichBolt
{
    ...
    public void execute(Tuple tuple) 
    {
      LOG.info(tuple.getStringByField(TruckScheme.FIELD_DRIVER_ID)  + "," + 
			  ...
			  tuple.getStringByField(TruckScheme.FIELD_FOGGY)+ "," +
			  tuple.getStringByField(TruckScheme.FIELD_RAINY)+ "," +
			  tuple.getStringByField(TruckScheme.FIELD_WINDY)+ "," +
			  tuple.getStringByField(TruckScheme.FIELD_ROUTENAME)+ "," +
			  tuple.getStringByField(TruckScheme.FIELD_STATE)); //add here
    }
